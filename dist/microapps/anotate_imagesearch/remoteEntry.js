...
var moduleMap = {
	"./Module": () => {
		return __webpack_require__.e(/* __federation_expose_Module */ 4936).then(() => (() => ((__webpack_require__(8728)))));
	}
};
...
function getBuilderId() {
    //@ts-ignore
    return  true ? "anotate_imagesearch:0.0.0" : 0;
}
...
/******/ 	anotate_imagesearch = __webpack_exports__;
/******/ 	
/******/ })()
;
