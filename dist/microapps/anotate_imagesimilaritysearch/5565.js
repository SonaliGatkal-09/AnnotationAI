"use strict";
(self["webpackChunkanotate_imagesimilaritysearch"] = self["webpackChunkanotate_imagesimilaritysearch"] || []).push([[5565],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Title: () => (/* binding */ Title),
  Toast: () => (/* binding */ Toast),
  ToastAction: () => (/* binding */ ToastAction),
  ToastClose: () => (/* binding */ ToastClose),
  ToastDescription: () => (/* binding */ ToastDescription),
  ToastProvider: () => (/* binding */ ToastProvider),
  ToastTitle: () => (/* binding */ ToastTitle),
  ToastViewport: () => (/* binding */ ToastViewport),
  Viewport: () => (/* binding */ Viewport),
  createToastScope: () => (/* binding */ createToastScope)
});
...
var dist_Root = (/* unused pure expression or super */ null && (Portal));
...
var [Collection, useCollection, createCollectionScope] = (0,react_collection_dist/* createCollection */.N)("Toast");
var [createToastContext, createToastScope] = (0,react_context_dist/* createContextScope */.A)("Toast", [createCollectionScope]);
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = index_js_.useState(0);
  const isFocusedToastEscapeKeyDownRef = index_js_.useRef(false);
  const isClosePausedRef = index_js_.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(Collection.Provider, { scope: __scopeToast, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    ToastProviderProvider,
    {
      ...
      onToastAdd: index_js_.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: index_js_.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = index_js_.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = index_js_.useRef(null);
    const tailFocusProxyRef = index_js_.useRef(null);
    const ref = index_js_.useRef(null);
    ...
    const getSortedTabbableCandidates = index_js_.useCallback(
      ({ tabbingDirection }) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      Branch,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(Collection.Slot, { scope: __scopeToast, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(react_primitive_dist/* Primitive */.sG.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            FocusProxy,
            {
...
var FocusProxy = index_js_.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, onFocusFromOutsideViewport, ...proxyProps } = props;
    const context = useToastProviderContext(FOCUS_PROXY_NAME, __scopeToast);
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      react_visually_hidden_dist/* VisuallyHidden */.s,
      {
        "aria-hidden": true,
        tabIndex: 0,
        ...proxyProps,
...
var Toast = index_js_.forwardRef(
  (props, forwardedRef) => {
    const { forceMount, open: openProp, defaultOpen, onOpenChange, ...toastProps } = props;
    const [open = true, setOpen] = (0,react_use_controllable_state_dist/* useControllableState */.i)({
      prop: openProp,
      defaultProp: defaultOpen,
      onChange: onOpenChange
    });
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(react_presence_dist/* Presence */.C, { present: forceMount || open, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
        ...
        onPause: (0,react_use_callback_ref_dist/* useCallbackRef */.c)(props.onPause),
        onResume: (0,react_use_callback_ref_dist/* useCallbackRef */.c)(props.onResume),
...
var ToastImpl = index_js_.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = index_js_.useState(null);
    const composedRefs = (0,react_compose_refs_dist/* useComposedRefs */.s)(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = index_js_.useRef(null);
    const swipeDeltaRef = index_js_.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = index_js_.useRef(0);
    const closeTimerRemainingTimeRef = index_js_.useRef(duration);
    const closeTimerRef = index_js_.useRef(0);
    const { onToastAdd, onToastRemove } = context;
    const handleClose = (0,react_use_callback_ref_dist/* useCallbackRef */.c)(() => {
      const isFocusInToast = node?.contains(document.activeElement);
      if (isFocusInToast) context.viewport?.focus();
      onClose();
    });
    const startTimer = index_js_.useCallback(
      (duration2) => {
    ...
    const announceTextContent = index_js_.useMemo(() => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: react_dom_index_js_.createPortal(
        /* @__PURE__ */ (0,jsx_runtime.jsx)(Collection.ItemSlot, { scope: __scopeToast, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          Root,
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              react_primitive_dist/* Primitive */.sG.li,
              {
                role: "status",
                "aria-live": "off",
                "aria-atomic": true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = index_js_.useState(false);
  const [isAnnounced, setIsAnnounced] = index_js_.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  index_js_.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : /* @__PURE__ */ (0,jsx_runtime.jsx)(Portal, { asChild: true, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(react_visually_hidden_dist/* VisuallyHidden */.s, { ...announceProps, children: renderAnnounceText && /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = index_js_.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(react_primitive_dist/* Primitive */.sG.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME;
var DESCRIPTION_NAME = "ToastDescription";
var ToastDescription = index_js_.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(react_primitive_dist/* Primitive */.sG.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME;
var ACTION_NAME = "ToastAction";
var ToastAction = index_js_.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = index_js_.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = index_js_.forwardRef((props, forwardedRef) => {
...
function dist_handleAndDispatchCustomEvent(name, handler, detail, { discrete }) {
  ...
  if (discrete) {
    (0,react_primitive_dist/* dispatchDiscreteCustomEvent */.hO)(currentTarget, event);
  } else {
...
function useNextFrame(callback = () => {
  ...
  const fn = (0,react_use_callback_ref_dist/* useCallbackRef */.c)(callback);
