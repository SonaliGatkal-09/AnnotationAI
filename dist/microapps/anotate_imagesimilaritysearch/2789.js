"use strict";
(self["webpackChunkanotate_imagesimilaritysearch"] = self["webpackChunkanotate_imagesimilaritysearch"] || []).push([[2789],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ useEmblaCarousel)
});
...
function useEmblaCarousel(options = {}, plugins = []) {
  const storedOptions = (0,index_js_.useRef)(options);
  const storedPlugins = (0,index_js_.useRef)(plugins);
  const [emblaApi, setEmblaApi] = (0,index_js_.useState)();
  const [viewport, setViewport] = (0,index_js_.useState)();
  const reInit = (0,index_js_.useCallback)(() => {
