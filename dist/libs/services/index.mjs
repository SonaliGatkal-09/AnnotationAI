...
const { toString: Qe } = Object.prototype, { getPrototypeOf: le } = Object, { iterator: W, toStringTag: Ce } = Symbol, K = /* @__PURE__ */ ((e) => (t) => {
  const n = Qe.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), C = (e) => (e = e.toLowerCase(), (t) => K(t) === e), X = (e) => (t) => typeof t === e, { isArray: B } = Array, I = X("undefined");
function Ze(e) {
...
const et = X("string"), A = X("function"), Pe = X("number"), G = (e) => e !== null && typeof e == "object", tt = (e) => e === !0 || e === !1, z = (e) => {
  if (K(e) !== "object")
    return !1;
  const t = le(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Ce in e) && !(W in e);
}, nt = C("Date"), rt = C("File"), st = C("Blob"), ot = C("FileList"), it = (e) => G(e) && A(e.pipe), at = (e) => {
  let t;
...
const U = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, _e = (e) => !I(e) && e !== U;
function re() {
...
const ht = (e, t, n, { allOwnKeys: r } = {}) => (q(t, (s, o) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, Rt = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && le(Uint8Array)), gt = (e, t) => {
  ...
  for (; (n = e.exec(t)) !== null; )
    r.push(n);
  return r;
}, Ot = C("HTMLFormElement"), Tt = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), pe = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), At = C("RegExp"), Ue = (e, t) => {
...
function Ft(e) {
  return !!(e && A(e.append) && e[Ce] === "FormData" && e[W]);
}
const _t = (e) => {
  ...
  return n(e, 0);
}, Ut = C("AsyncFunction"), Lt = (e) => e && (G(e) || A(e)) && A(e.then) && A(e.catch), Le = ((e, t) => e ? setImmediate : t ? ((n, r) => (U.addEventListener("message", ({ source: s, data: o }) => {
  ...
  A(U.postMessage)
), Dt = typeof queueMicrotask < "u" ? queueMicrotask.bind(U) : typeof process < "u" && process.nextTick || Le, Bt = (e) => e != null && A(e[W]), a = {
  isArray: B,
  isArrayBuffer: Ne,
  isBuffer: Ze,
  isFormData: at,
...
function Q(e, t, n) {
  ...
  function u(d, y, h) {
    ...
    if (d && !h && typeof d == "object") {
      ...
      else if (a.isArray(d) && jt(d) || (a.isFileList(d) || a.endsWith(y, "[]")) && (w = a.toArray(d)))
...
}, Ht = typeof URLSearchParams < "u" ? URLSearchParams : ue, Mt = typeof FormData < "u" ? FormData : null, zt = typeof Blob < "u" ? Blob : null, $t = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Ht,
    FormData: Mt,
...
}, fe = typeof window < "u" && typeof document < "u", oe = typeof navigator == "object" && navigator || void 0, Jt = fe && (!oe || ["ReactNative", "NativeScript", "NS"].indexOf(oe.product) < 0), vt = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Vt = fe && window.location.href || "http://localhost", Wt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: fe,
...
const Je = (e) => {
  ...
  t.headers = i = x.from(i), t.url = Ie($e(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), c && i.set(
    "Authorization",
...
}, Z = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", ve = Z && typeof ReadableStream == "function", wn = Z && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), Ve = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
  ...
  return e && !t;
}), Se = 64 * 1024, ie = ve && Ve(() => a.isReadableStream(new Response("").body)), V = {
  stream: ie && ((e) => e.body)
};
Z && ((e) => {
...
const Rn = async (e) => {
  ...
  let R = hn([s, o && o.toAbortSignal()], i), d;
  const y = R && R.unsubscribe && (() => {
    R.unsubscribe();
  });
  let h;
  try {
    if (f && En && n !== "get" && n !== "head" && (h = await gn(u, r)) !== 0) {
      let T = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
...
function Te(e) {
  return ne(e), e.headers = x.from(e.headers), e.data = te.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), We.getAdapter(e.adapter || H.adapter)(e).then(function(r) {
...
const {
  ...
  return t.interceptors.request.use(
    (r) => (r.headers.Authorization = `Bearer ${n()}`, r.headers["X-component"] = e, (r.method === "post" || r.method === "put" || r.method === "patch") && console.log(r.data, r.url), r),
    (r) => Promise.reject(new Error(r))
  ), t.interceptors.response.use(
    (r) => r,
    (r) => Promise.reject(r)
  ), t.interceptors.response.use(void 0, (r) => (console.log(r, e), Promise.reject(r))), t;
};
class Fn {
  constructor(t = "") {
    this.axiosInstance = Pn(t);
  }
  async get(t, n) {
    return this.axiosInstance.get(t, n);
  }
  async post(t, n, r) {
    return await this.axiosInstance.post(t, n, r);
  }
  async put(t, n) {
    return await this.axiosInstance.put(t, n);
  }
  async delete(t, n) {
    return await this.axiosInstance.delete(t, n);
  }
  async patch(t, n) {
    return await this.axiosInstance.patch(t, n);
  }
}
class Xn {
  constructor(t) {
    ...
    }, this.fetchclassDistributionData = async () => [
    ...
    ], this.httpClient = new Fn(t);
  }
}
export {
  Xn as DashboardService
};
